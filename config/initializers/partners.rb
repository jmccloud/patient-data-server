    ...
    module C32
      class AllergyImporter < SectionImporter
        ...
        def initialize
          ...
          @description_xpath = "./cda:code/cda:originalText/cda:reference[@value] | ./cda:text/cda:reference[@value] | ./cda:participant/cda:participantRole/cda:playingEntity/cda:code/cda:originalText/cda:reference[@value]"
          @type_xpath = "./cda:code"
...
#             extract_reaction(entry_element, allergy)
...
#         def extract_reaction(parent_element, allergy)
# 					value_element = parent_element.at_xpath(@reaction_xpath)
#         	unless value_element.nil?
# 						allergy.reaction = {}        	
#         		debugger
#         		translation_element = value_element.at_xpath("./cda:translation")
#         		unless translation_element.nil?
#         			allergy.reaction['name'] = translation_element['displayName']
#         		else
#         			allergy.reaction['name'] = value_element.at_xpath("./cda:originalText")
#         		end
#         	end
#       	end
  ...
  module Import
    module C32
      class ResultImporter < SectionImporter
        ...
        def extract_description(parent_element, result, id_map={})
        	text_element = parent_element.at_xpath("./cda:code[cda:translation]/cda:originalText")
    			unless text_element.nil?
    				result.description = text_element
    			else
    				super
    			end
        end
